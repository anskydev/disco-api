defmodule Disco.OrderingTest do
  use Disco.DataCase, async: true

  alias Disco.Ordering
  ...
  describe "orders" do
    ...
    test "create_order/1 with valid data creates a order" do
      chai = Repo.get_by!(Disco.Menu.Item, name: "Masala Chai")
      fries = Repo.get_by!(Disco.Menu.Item, name: "French Fries")
